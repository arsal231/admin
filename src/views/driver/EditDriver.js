...
const EditDriver = () => {
  ...
  useEffect(()=>{
    ...
    //console.log(vehicleObj.id);
     SetDriverId(vehicleObj.id);
   // getVehiclesType();
     getDriver(vehicleObj.id);
  ...
  async function getDriver(id)
     { 
       ...
       let responseData = await fetch(API_URL+'/get_driver/'+id);
    ...
    //  }
      let feildsData = 
      {
          ...
          Status,
             ...
             fetch(API_URL+"/update_driver/"+DriverId,
             {
             method:'PUT',
             headers:
  ...
  const goBack = () => {
    ...
    navigate('/driver/listing');// This will navigate back to the previous page
  };
  return (
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            ...
            <strong>Edit <strong> &quot;{UserName}&quot; </strong> Driver <span>
